...
export default function CTA2() {
  return (
    <div className="relative w-full max-w-4xl overflow-hidden rounded-[40px] mx-auto  p-6 sm:p-10 md:p-20">
      <div className="absolute inset-0 hidden h-full w-full overflow-hidden md:block">
        <div className="absolute top-1/2 right-[-45%] aspect-square h-[800px] w-[800px] -translate-y-1/2">
          <div className="absolute inset-0 rounded-full bg-primary/20 opacity-30"></div>
      ...
      <div className="relative z-10">
        ...
        <p className="mb-6 max-w-md text-base t sm:text-lg md:mb-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:gap-6">
          <button
            ...
            className="flex w-full items-center justify-between rounded-full bg-black px-5 py-3 text-white sm:w-60"
          >
